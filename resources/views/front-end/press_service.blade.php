            ...
            <div class="left_block">
                <div class="wrap flex_row">
                    ...
                    <div class="content"><a href="#">ГП "Узбекиский национальный институт метрологии" Агентсвто Узстандарт обявляет тендер</a>
                        ...
                        <div class="ftr">
                            <img src="{{ asset('front-end/media/img/svg/clock.svg') }}" alt="" class="clock"> <span>18:00</span>
                            <img src="{{ asset('front-end/media/img/svg/eye.svg') }}" alt="" class="eye"> <span>Просмотри: 1440</span>
                        </div>
