                        ...
                        <div class="panel-body">
                            ...
                            @if($lang == 'uz')
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'title_uz',
                                ])
                                <input type="text" class="form-control" id="title" name="title_uz" placeholder="{{ __('voyager::generic.title') }}" value="@if(isset($dataTypeContent->title_uz)){{ $dataTypeContent->title_uz }}@endif">
                            @elseif($lang == 'cyrl')
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'title_cyrl',
                                ])
                                <input type="text" class="form-control" id="title" name="title_cyrl" placeholder="{{ __('voyager::generic.title') }}" value="@if(isset($dataTypeContent->title_cyrl)){{ $dataTypeContent->title_cyrl }}@endif">
                            @elseif($lang == 'ru')
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'title_ru',
                                ])
                                <input type="text" class="form-control" id="title" name="title_ru" placeholder="{{ __('voyager::generic.title') }}" value="@if(isset($dataTypeContent->title_ru)){{ $dataTypeContent->title_ru }}@endif">
                            @elseif($lang == 'en')
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'title_en',
                                ])
                                <input type="text" class="form-control" id="title" name="title_en" placeholder="{{ __('voyager::generic.title') }}" value="@if(isset($dataTypeContent->title_en)){{ $dataTypeContent->title_en }}@endif">
                            @endif
                        </div>
                    </div>
